...
class CTFApp {
  ...
  getDefaultContent() {
    return {
      ...
      clubs: [
        { name: "DUCA", campus: "Deakin University", url: "https://duca.org.au" },
        { name: "UNSW Security Society", campus: "UNSW Sydney", url: "https://unswsecurity.com" },
        { name: "Monash Cybersecurity", campus: "Monash University", url: "https://monashcyber.org" },
        { name: "UQ Cyber", campus: "University of Queensland", url: "https://uqcyber.org" },
        { name: "ANU Security", campus: "Australian National University", url: "https://anusecurity.org" },
        { name: "UTS Security", campus: "University of Technology Sydney", url: "https://utssecurity.org" }
      ],
      sponsors: [
        { name: "Legion Offensive Security", url: "https://legionoffensivesecurity.com/", logo: "/assets/sponsors/LEGION.png" }
      ],
      faqs: [
        { q: "Who can join?", a: "Australian uni and TAFE students, recent grads, and early-career participants." },
  ...
  populateClubs() {
    ...
    const createClubElement = (club) => {
      ...
      clubEl.innerHTML = `
        <div class="club-logo" style="background: var(--surface-alt);"></div>
        <div class="club-info">
          <h4>${club.name}</h4>
          <p>${club.campus}</p>
        </div>
